...
* **@aws-amplify/auth:** Valide OAuth state only when generated by Amlify ([#3069](https://github.com/stephankaag/aws-amplify/issues/3069)) ([30e828f](https://github.com/stephankaag/aws-amplify/commit/30e828f)), closes [#3054](https://github.com/stephankaag/aws-amplify/issues/3054) [#3055](https://github.com/stephankaag/aws-amplify/issues/3055)
* **aws-amplify-react:** adds e.preventDefault to confirm function in ConfirmSignIn component to prevent page reload ([b4ee413](https://github.com/stephankaag/aws-amplify/commit/b4ee413))
* **aws-amplify-react:** Fix typo in german localisation ([a5592f2](https://github.com/stephankaag/aws-amplify/commit/a5592f2))
* **aws-amplify-react:** image will reload when level is changed ([0b39eb6](https://github.com/stephankaag/aws-amplify/commit/0b39eb6))
* add a todo to the greeting object in order to adjust the Angular Greeting Component to match React, fix typo in requireNewPassword ([49eae14](https://github.com/stephankaag/aws-amplify/commit/49eae14))
* check is component is mounted ([47ae0b9](https://github.com/stephankaag/aws-amplify/commit/47ae0b9))
* German localisation ([80c87ea](https://github.com/stephankaag/aws-amplify/commit/80c87ea))
* update cypress version and fix auth text check ([4fb2356](https://github.com/stephankaag/aws-amplify/commit/4fb2356))
* **@aws-amplify-react/auth:** handle required attributes in NEW_PASSWORD_REQUIRED challenge ([5ee6288](https://github.com/stephankaag/aws-amplify/commit/5ee6288))
* **@aws-amplify/auth:** Adding theme support to the FederatedButtons "or" Strike ([554c1fc](https://github.com/stephankaag/aws-amplify/commit/554c1fc))
* **@aws-amplify/auth:** currentAuthenticatedUser throws error when the user is disabled/deleted ([1b09e2f](https://github.com/stephankaag/aws-amplify/commit/1b09e2f))
* **aws-amplify-angular:** Angular rollup ([#1441](https://github.com/stephankaag/aws-amplify/issues/1441)) ([eb84e01](https://github.com/stephankaag/aws-amplify/commit/eb84e01))
* **aws-amplify-react:** add I18n in Greetings ([e549db7](https://github.com/stephankaag/aws-amplify/commit/e549db7))
* **aws-amplify-react:** authData in Greetings ([a1fef5b](https://github.com/stephankaag/aws-amplify/commit/a1fef5b))
* **aws-amplify-react:** change the way to import qrcode ([8afd5dd](https://github.com/stephankaag/aws-amplify/commit/8afd5dd))
* **aws-amplify-react:** change to forgetpassword state if need to reset password ([0c1e994](https://github.com/stephankaag/aws-amplify/commit/0c1e994))
* **aws-amplify-react:** check if gapi is inited when mounting the component ([9a7d306](https://github.com/stephankaag/aws-amplify/commit/9a7d306))
* **aws-amplify-react:** correctly hide links under production mode ([8a52918](https://github.com/stephankaag/aws-amplify/commit/8a52918))
* **aws-amplify-react:** Fix import statement ([fe1826a](https://github.com/stephankaag/aws-amplify/commit/fe1826a)), closes [#1482](https://github.com/stephankaag/aws-amplify/issues/1482)
* **aws-amplify-react:** Fix import statement ([#1695](https://github.com/stephankaag/aws-amplify/issues/1695)) ([07bdfc2](https://github.com/stephankaag/aws-amplify/commit/07bdfc2)), closes [#1482](https://github.com/stephankaag/aws-amplify/issues/1482) [#1484](https://github.com/stephankaag/aws-amplify/issues/1484)
* **aws-amplify-react:** fix instances of missing theme prop ([77904be](https://github.com/stephankaag/aws-amplify/commit/77904be))
* **aws-amplify-react:** fix PhotoPicker preview ([db3331e](https://github.com/stephankaag/aws-amplify/commit/db3331e))
* **aws-amplify-react:** fix the break change of federatedSignIn ([5ca239c](https://github.com/stephankaag/aws-amplify/commit/5ca239c))
* **aws-amplify-react:** fix the phone number format in sign up component ([a21d486](https://github.com/stephankaag/aws-amplify/commit/a21d486))
* **aws-amplify-react:** jump to the initial state if not signed in ([d8779eb](https://github.com/stephankaag/aws-amplify/commit/d8779eb))
* **aws-amplify-react:** only call Auth signOut if some error happens during signed in ([1ceb3ef](https://github.com/stephankaag/aws-amplify/commit/1ceb3ef))
* **aws-amplify-react:** pass the user name when signin error happens ([b857101](https://github.com/stephankaag/aws-amplify/commit/b857101))
* **aws-amplify-react:** show the link of create account when using customized signup component ([1b4de49](https://github.com/stephankaag/aws-amplify/commit/1b4de49))
* **aws-amplify-react:** the username should not be undefined ([5ebddcb](https://github.com/stephankaag/aws-amplify/commit/5ebddcb))
* **aws-amplify-react:** transfer the children object to array ([b734d99](https://github.com/stephankaag/aws-amplify/commit/b734d99))
* **core:** Remove unneeded Hub.dispatch and Hub.listen ([#2919](https://github.com/stephankaag/aws-amplify/issues/2919)) ([aea7fa9](https://github.com/stephankaag/aws-amplify/commit/aea7fa9)), closes [#2623](https://github.com/stephankaag/aws-amplify/issues/2623)
* remove stray semicolon after app wrapper ([d2d5fa3](https://github.com/stephankaag/aws-amplify/commit/d2d5fa3))
* **aws-amplify-react:** use <form/> for the login component ([8f94b32](https://github.com/stephankaag/aws-amplify/commit/8f94b32))
* **aws-amplify-react aws-amplify-react-native:** Connect component ([#1868](https://github.com/stephankaag/aws-amplify/issues/1868)) ([8dd6b55](https://github.com/stephankaag/aws-amplify/commit/8dd6b55))
* **integration tests:** CircleCI workflows and Cypress integration testing ([#1071](https://github.com/stephankaag/aws-amplify/issues/1071)) ([bfa4776](https://github.com/stephankaag/aws-amplify/commit/bfa4776))
* **pushnotification:** revert change in pr 952 ([b8d167c](https://github.com/stephankaag/aws-amplify/commit/b8d167c))
* **pushnotification:** revert change in pr 952 ([257fc40](https://github.com/stephankaag/aws-amplify/commit/257fc40))


### Features

* **@aws-amplify/auth:** Easier Federation with OAuth ([#3005](https://github.com/stephankaag/aws-amplify/issues/3005)) ([76cde59](https://github.com/stephankaag/aws-amplify/commit/76cde59))
* **@aws-amplify/interactions @aws-amplify/react @aws-amplify/react-native @aws-amplify/angular @aws-amplify/vue:** Update interactions to include voice ([#2121](https://github.com/stephankaag/aws-amplify/issues/2121)) ([938d2a5](https://github.com/stephankaag/aws-amplify/commit/938d2a5))
* **aws-amplify-react:** Add Auth0 button ([b16ded3](https://github.com/stephankaag/aws-amplify/commit/b16ded3))
* **aws-amplify-react:** add identityId prop to S3Album, S3Image, S3Text ([#2459](https://github.com/stephankaag/aws-amplify/issues/2459)) ([26e1345](https://github.com/stephankaag/aws-amplify/commit/26e1345)), closes [#2424](https://github.com/stephankaag/aws-amplify/issues/2424)
* **aws-amplify-react:** adding loading page ([c47f72a](https://github.com/stephankaag/aws-amplify/commit/c47f72a))
* **aws-amplify-react:** allow user to sign up with email or phone number ([b81f89e](https://github.com/stephankaag/aws-amplify/commit/b81f89e))
* **aws-amplify-react:** disable sign in button while loading ([#2216](https://github.com/stephankaag/aws-amplify/issues/2216)) ([b196b7f](https://github.com/stephankaag/aws-amplify/commit/b196b7f))
* **aws-amplify-react:** federated sign out methods refactor ([9edbd6e](https://github.com/stephankaag/aws-amplify/commit/9edbd6e))
* **aws-amplify-react-native:** Add withOAuth HOC for Cognito Hosted UI ([#2665](https://github.com/stephankaag/aws-amplify/issues/2665)) ([ac4d232](https://github.com/stephankaag/aws-amplify/commit/ac4d232))
* UI Components ([1ff1abd](https://github.com/stephankaag/aws-amplify/commit/1ff1abd))
* **interactions:** Interactions UI components for react and react native ([#1105](https://github.com/stephankaag/aws-amplify/issues/1105)) ([57de248](https://github.com/stephankaag/aws-amplify/commit/57de248))


* Amplify ui migration (#1517) ([41d3184](https://github.com/stephankaag/aws-amplify/commit/41d3184)), closes [#1517](https://github.com/stephankaag/aws-amplify/issues/1517)
